...
public class TC_PatientPrograms_Invalid_Auth_Info extends BaseTest{

	
	
	@Test(priority = 1)
	public void GetPatientPrograms_CheckResponseWithInvalidAuth() throws JsonProcessingException
	{
	...
	@Test(priority = 2)
	public void GetPatientPrograms_CheckResponseWithNoAuth() throws JsonProcessingException
	{
