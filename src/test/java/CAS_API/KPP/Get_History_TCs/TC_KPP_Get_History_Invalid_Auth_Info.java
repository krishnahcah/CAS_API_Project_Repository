...
package CAS_API.KPP.Get_History_TCs;
...
public class TC_KPP_Get_History_Invalid_Auth_Info extends BaseTest{

	
	@Test(priority = 1)
	public void CheckKPPHistoryResponseWithInvalidAuth() throws JsonProcessingException
	{
		...
		response = RestAssured.given().header("Authorization",FrameworkConstants.Invalid_Authorization).
				...
				when().
				get(API_Endpoint.Endpoints.KPPGetHistory);
	...
	@Test(priority = 2)
	public void CheckKPPHistoryResponseWithMissingAuth() throws JsonProcessingException
	{
