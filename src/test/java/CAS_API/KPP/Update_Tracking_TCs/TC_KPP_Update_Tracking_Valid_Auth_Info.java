...
package CAS_API.KPP.Update_Tracking_TCs;
...
public class TC_KPP_Update_Tracking_Valid_Auth_Info extends BaseTest{

	
	@Test(priority = 1)
	public void CheckKPPUpdateTrackingResponseWithValidAuth_ValidBody() throws JsonProcessingException
	{
		...
		response = RestAssured.given().
				...
				pathParam("module_id", "3").pathParam("track_id", "1").
				when().
				post(API_Endpoint.Endpoints.postUpdateTracking);
	...
	@Test(priority = 2)
	public void CheckKPPUpdateTrackingResponseWithValidAuth_NoBody() throws JsonProcessingException
	{
